...
using PersonalManagement.Api.Extensions;
...
namespace PersonalManagement.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlite("Data Source=Context\\PersonalManager.db");
            });
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "PersonalManagement.Api", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "PersonalManagement.Api v1"));
            }
